...
## 기업명 추출 개선
- 뉴스 제목 전체를 기업명으로 사용하지 않습니다.
- 법인명 표기, 제목 선두의 기업명, Naver 지역/쇼핑의 업체·브랜드명을 우선합니다.
- `안녕하세요`, `무자본 창업할 방법`, `전 세계가 주목하는 K-뷰티` 같은 문장형 검색결과는 후보에서 제외합니다.
- 후보마다 `nameConfidence`와 `nameEvidence`를 저장합니다.
- 신뢰도 0.80 미만의 뉴스 제목 기반 후보는 Naver 지역/쇼핑에서 별도 확인되지 않는 한 제외합니다.
